...
CREATE TABLE IF NOT EXISTS `lexis_nexis`.`APPL_RUN_STAT` (
  `APPL_RUN_STAT_REC_ID` INT(11) NOT NULL AUTO_INCREMENT,
  `APPL_RUN_STAT_VAL` INT(11) NOT NULL,
  `APPL_RUN_STAT_REC_EFF_DT` DATETIME NOT NULL,
  `APPL_RUN_STAT_REC_TRMN_DT` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`APPL_RUN_STAT_REC_ID`),
  INDEX `APPL_RUN_STAT_ID_IDX` (`APPL_RUN_STAT_REC_ID` ASC))
ENGINE = InnoDB
...
BEGIN
	...
	INSERT INTO APPL_USR_SRCH_STAT (APPL_USR_SRCH_SVD_NME, APPL_USR_SRCH_USR_NME,
		...
		APPL_USR_SRCH_RSLT_LOC, APPL_USR_SRCH_PCT_CMPLT, APPL_USR_SRCH_QRY, APPL_USR_SRCH_SRC, APPL_USR_SRCH_ST_DT, APPL_USR_SRCH_END_DT,
        APPL_USR_SRCH_CURR_ST_DT, APPL_USR_SRCH_CURR_END_DT, APPL_USR_SRCH_ST_INDX, APPL_USR_SRCH_MTHD, APPL_USR_SRCH_RETRY_CNT, APPL_USR_SRCH_CREATE_DT)
	VALUES (SRCH_NME, SRCH_USR, STAT_CD, NOW(), NULL, NULL, 0.0, SRCH_QRY, SRCH_SRC, SRCH_FROM_DT, SRCH_TO_DT, SRCH_FROM_DT, SRCH_TO_DT, 1, SRCH_MTHD,0, NOW());
END$$
...
BEGIN
  ...
  ORDER BY S.APPL_USR_SRCH_STAT_REC_ID ASC;
 END$$
...
BEGIN
 ...
 DATE_FORMAT(S.APPL_USR_SRCH_CREATE_DT, '%b %d %Y %h:%i %p') AS APPL_USR_SRCH_REC_EFF_DT, 
    ...
    CASE WHEN L.APPL_LKUP_DESC = 'Complete' AND S.APPL_USR_SRCH_NUM_RSLTS = 0 THEN 'Cancel' 
		WHEN L.APPL_LKUP_DESC = 'Complete' THEN 'Download'
	...
	S.APPL_USR_SRCH_NUM_RSLTS,
     CASE WHEN L.APPL_LKUP_DESC IN ('Pending','Processing') THEN (SELECT COUNT(*) 
        FROM APPL_USR_SRCH_STAT T INNER JOIN APPL_LKUP L ON T.APPL_USR_SRCH_STAT_CD = L.APPL_LKUP_CD 
        WHERE T.APPL_USR_SRCH_REC_TRMN_DT IS NULL AND L.APPL_LKUP_DESC IN ('Pending','Processing')
        AND S.APPL_USR_SRCH_USR_NME = USR_NME
		AND T.APPL_USR_SRCH_STAT_REC_ID < S.APPL_USR_SRCH_STAT_REC_ID)+1 
        ELSE NULL END AS QUEUE_POS,
	S.APPL_USR_SRCH_QRY
  FROM APPL_USR_SRCH_STAT S
...
INSERT INTO APPL_USR_SRCH_STAT_HIST (APPL_USR_SRCH_SVD_NME, APPL_USR_SRCH_USR_NME,
            ...
            APPL_USR_SRCH_CURR_ST_DT, APPL_USR_SRCH_CURR_END_DT, APPL_USR_SRCH_ERR_MSG, APPL_USR_SRCH_RETRY_CNT, APPL_USR_SRCH_CREATE_DT)
	VALUES (old.APPL_USR_SRCH_SVD_NME, old.APPL_USR_SRCH_USR_NME,
            ...
            old.APPL_USR_SRCH_CURR_ST_DT, old.APPL_USR_SRCH_CURR_END_DT, old.APPL_USR_SRCH_ERR_MSG, old.APPL_USR_SRCH_RETRY_CNT, old.APPL_USR_SRCH_CREATE_DT);
END$$
...
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (9, 100, 'LOG_CD', 'UI Error', now());
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (11, 101, 'LOG_CD', 'Web Service Error', now());
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (13, 102, 'LOG_CD', 'Database Error', now());
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (15, 0, 'RUN_STAT', 'Not Running', now());
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (17, 1, 'RUN_STAT', 'Running', now());
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (19, 0, 'RUN_STAT', 'Not Running', now());
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (21, 280434, 'COMMON_SRC', 'All News, All Languages', now());
...
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (25, 161887, 'COMMON_SRC', 'English Language News - Most Recent 90 Days', now());
...
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (29, 232166, 'COMMON_SRC', 'Non-English Language News - Most Recent 90 Days', now());
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (31, 8422, 'COMMON_SRC', 'Major Newspapers', now());
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (33, 307555, 'COMMON_SRC', 'Major Non-US Newspapers', now());
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (35, 307574, 'COMMON_SRC', 'Major US Newspapers', now());
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (37, 238672, 'COMMON_SRC', 'Major World Newspapers', now());
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (39, 103, 'LOG_CD', 'Web Service Call', now());

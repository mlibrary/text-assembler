...
INSERT INTO `lexis_nexis`.`APPL_LKUP` (`APPL_LKUP_REC_ID`, `APPL_LKUP_CD`, `APPL_LKUP_CATG_NME`, `APPL_LKUP_DESC`, `APPL_LKUP_REC_EFF_DT`) VALUES (DEFAULT, 104, 'LOG_CD', 'UI Call', now());
